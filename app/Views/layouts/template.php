                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse justify-content-end">
                        ...
                        <?php
                                ...
                                $query = $builder->where(['user_id' => session()->get('id')])->get(); 
                        ...
                        <ul class="navbar-nav">
                            <li class="dropdown nav-item">
                                ...
                                <?php if ($total!=0){ ?>
                                        ...
                                        <a class="dropdown-item" href="#">
                                            <div class="card mt-1 mb-1" style="max-width: 540px;">
                                                <div class="row no-gutters">
                                                    <div class="col-md-4">
                                                    <img src="<?= base_url(); ?>/assets/img/materials/<?= $row->name; ?>.jpg" class="card-img" />
                                                    </div>
                                                    <div class="col-md-8">
                                                        <div class="card-body">
                                                            <h5 class="card-title"><?= substr($row->description,0,21); ?></h5>
                                                            <h5 class="card-title"><?= substr($row->description,21,42); ?></h5>
                                                            <h5 class="card-title"><?= substr($row->description,42,63); ?></h5>
                                                            <p class="card-text"><?= $row->name; ?></p>
                                                            <p class="card-text"><small class="text-muted"><?= $row->order_qty.' '.$row->uom; ?></small></p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <?php } ?>
                                        <li class="divider"></li>
                                        <a class="dropdown-item bg-primary text-center text-light" href="<?= base_url('/cart'); ?>">Checkout</a>
                                <!-- </ul> -->
                                <?php }else{ ?>
                                    <!-- <ul class="dropdown-menu dropdown-menu-right" style="min-width: 25rem;"> -->
                                        <a class="dropdown-item" href="#">
